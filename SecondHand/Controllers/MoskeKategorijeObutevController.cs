...
namespace SecondHand.Controllers
{
	public class MoskeKategorijeObutevController : Controller
	{
		...
		public MoskeKategorijeObutevController(AppDbContext context, UserManager<ApplicationUser> usermanager)
		{
			_context = context;
		...
		public IActionResult Index()
		{
			...
			var data = _context.KategorijeCevljis.Where(p => p.Spol.Equals('M')).ToList();
			return View(data);
		}
